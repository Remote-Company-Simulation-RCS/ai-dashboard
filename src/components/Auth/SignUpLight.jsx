...
function SignUp() {
  ...
  return (
    <div className="sign-up light-signup d-flex flex-column align-items-center text-center">
      <img src={Logo} className="img-fluid py-5" alt="icon image" />
      <h2 className="title-signup text-center mb-5 ">Create account</h2>
      <p className="desc-signup lead text-black-50">
        ...
        <div className="col-12 col-lg-4 col-xl-4 card d-flex justify-content-center">
          <button className="text-start border-0 bg-transparent">
            ...
            <p className="text-secondary mb-0 mt-3">
              Sign up <br />
              <span className="text-black fw-bold">with Google</span>
            </p>
          </button>
        </div>
        <div className="col-12 col-lg-4 col-xl-4 card d-flex justify-content-center">
          <button className="text-start border-0 bg-transparent">
            ...
            <p className="text-secondary mb-0 mt-3">
              Sign up <br />
              <span className="text-black fw-bold">with Apple ID</span>
            </p>
          </button>
        </div>
        <div className="col-12 col-lg-4 col-xl-4 card card-yt d-flex justify-content-center">
          <button className="text-start border-0 bg-transparent z-3">
